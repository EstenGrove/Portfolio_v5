...
/**
 * startTime: the starting point for out timer's counter
 * step: how *much* do we increment on each tick (eg. 1s, 5s etc)
 * interval: how *often* do we increment our counter (eg. every 1s, 5s etc)
 */
